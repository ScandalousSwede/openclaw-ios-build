...
export const PLUGIN_COMPAT_RECORDS = [
  ...
  },
  {
    ...
    replacement:
      "`MsgContext.ChannelPromptContext`, `MsgContext.ChannelStructuredContext`, `ChannelStructuredContextEntry`, `SupplementalContextFacts.channelStructuredContext`, and `buildChannelMetadata`; retain aliases until supported external plugin migration is verified and explicit breaking-release removal is approved",
    docsPath: "/plugins/compatibility",
    surfaces: [
