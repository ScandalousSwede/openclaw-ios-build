...
class AIESQualificationWorkflowContractTests(unittest.TestCase):
    ...
    def test_unsigned_archive_uses_canonical_aies_identity_without_signing(self) -> None:
        ...
        self.assertIn("aps-environment", keychain_fixture)
        self.assertIn("OpenClaw.app-Simulated.xcent", keychain_fixture)
        self.assertIn("simulator-runtime-entitlement-contract.json", keychain_fixture)
        self.assertIn("application-identifier prefix", keychain_fixture)
