...
0.1.1 observability, PCM native Float32 output, stream-integrity, and playback-teardown-ownership patch to its original
...
PCM sample conversion, buffering/cancellation/error, and serialized teardown semantic delta, truthful observation limits,
